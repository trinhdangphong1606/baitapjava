...
<body>
  <div class="header-top">
   ...
   <div class="header-bottom">
       ...
       <div class="register_account comments-area">
          	<div class="wrap">
    	      <h4 class="title">Hi <%=user_of_techworld3g.getFirst_name()%> You can change your information </h4>
    		   <form action="UpdateUserController" method="post">
    			 <div class="col_1_of_2 span_1_of_2" >
                              
                                <div><input type="text" value="First Name" name="first_name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'First Name';}"></div>
		    		<div><input type="text" value="Username" name="user" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}"></div>
		    		<div><input type="text" value="Emaill" name ="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Emaill';}"></div>
		    		<div><input type="text"   value="Password" name ="pwd" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}"></div>		    	 
                         
                         </div>
		    	  <div class="col_1_of_2 span_1_of_2">	
                              <div><input type="text" value="Address" name="address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Address';}"></div>
		          ...
		          <div><input type="text" value="City" name="city" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'City';}"></div>
                          <div><input type="text" value="Phone" name="phone" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Phone';}"></div>
